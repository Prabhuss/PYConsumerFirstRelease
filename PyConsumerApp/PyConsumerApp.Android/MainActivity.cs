...
namespace PyConsumerApp.Droid
{
    ...
    [Activity(Label = "PY Dukan", Icon = "@mipmap/icon", Theme = "@style/MyTheme.Splash", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
